...
import com.hiocs.module.analysis.controller.model.LoginModel;
import com.hiocs.module.analysis.controller.model.LoginSuccessModel;
...
public class LoginController {
    ...
    @PostMapping("login")
    public ResponseEntity<LoginSuccessModel> login(@RequestBody @ApiParam(value = "用户登录信息", required = true) LoginModel model, HttpServletRequest request){
